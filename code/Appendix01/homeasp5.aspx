...
<FORM name="examform" id="examform" action="homeasp5.aspx" method="post" runat="server">
<div align="center">
  ...
  <tr>
	...
	<table BORDER="0" bordercolor="#000000" CELLSPACING="0" CELLPADDING="0" width="600">
	  <tr>
		...
		<asp:Image runat="server" ImageUrl="header.gif" ></asp:Image>
             </td>
	     <td bordercolor="#000000" valign="bottom" align="right" >
		<asp:Hyperlink runat="server" NavigateUrl="someurl1.asp" Font-Names="Tahoma" Font-Size="Smaller" >
sitemap</asp:Hyperlink>&nbsp;|&nbsp;<asp:Hyperlink runat="server" NavigateUrl="someurl2.asp" Font-Names="Tahoma" Font-Size="Smaller" >contact</asp:Hyperlink><br><br>
             </td>
	  </tr>
	</table>
     </td>
  ...
  <tr>
	...
	<table BORDER="0" bordercolor="#000000" CELLSPACING="0" CELLPADDING="10" width="600">
	  <tr>
	     <td bgcolor="#3A529C" align="center" valign="top" >
		<asp:Label runat="server" Font-Names="Verdana,Tahoma" ForeColor="#FFFFFF" Font-Size="Smaller" CssClass="content-wht">
<b>Exam date availability</b><br><br>Use this form to check how many seats are available for your preferred testing date.</asp:Label></td>
	  </tr>
	  <tr>
	     <td bgcolor="#00FFFF" align="center" valign="top" >

		<asp:Label runat="server" id="message" EnableViewState="True" Font-Names="Tahoma" ForeColor="#000000" Font-Size="Smaller" CssClass="content-blk"></asp:Label>
		<br><br>
		...
		<br><asp:Label runat="server" Font-Names="Tahoma" ForeColor="#000000" Font-Size="Smaller" CssClass="content-blk">Your selected date:</asp:Label><br>
