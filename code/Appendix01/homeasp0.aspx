...
' display results
    ...
    If (stillFree <> Nothing) Then
      Response.Write("There are " & stillFree & " remaining places for this exam.")
      If (stillFree>0) Then
        Response.Write("Click <a href=booking.asp>here</a> to book.")
      End If
    Else
      Response.Write("There are 5 places available for this exam. Click <a href=booking.asp>here</a> to book.")
    End If
...
End Sub
		...
		<br><FORM name="examform" action="homeasp0.aspx" method="get">
