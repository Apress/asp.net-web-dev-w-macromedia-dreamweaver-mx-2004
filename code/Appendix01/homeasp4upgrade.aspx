...
<FORM name="examform" id="examform" action="homeasp4upgrade.aspx" method="post" runat="server">
<div align="center">
  ...
  <tr>
	...
	<table BORDER="0" bordercolor="#000000" CELLSPACING="0" CELLPADDING="10" width="600">
	  ...
	  <tr>
		...
		<ASP:Repeater id="course" runat="server" >
		  <HeaderTemplate>
			<TABLE border="0" align="center" >
		  </HeaderTemplate>
		  <ItemTemplate>
			<tr><td align="left">
			<INPUT type="radio" name="course" ><%# DataBinder.Eval(Container.DataItem, "Course") %></INPUT>
			</td><td align="left">
			<IMG src=<%# DataBinder.Eval(Container.DataItem, "FlagFile") %> /><br>
			</td></tr>
		  </ItemTemplate>
		  <FooterTemplate>
			</table>
