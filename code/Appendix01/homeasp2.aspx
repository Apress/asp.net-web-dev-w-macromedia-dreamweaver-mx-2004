...
<FORM name="examform" id="examform" action="homeasp2.aspx" method="get" runat="server">
<div align="center">
  ...
  <tr>
	...
	<table BORDER="0" bordercolor="#000000" CELLSPACING="0" CELLPADDING="10" width="600">
	  ...
	  <tr>
		...
		<br><br><SELECT name="startday"><OPTION value="0">_Starting day_</OPTION>
<%
' the <% tags still work with ASP.NET
    Dim i As Integer
    For i=1 To 31
