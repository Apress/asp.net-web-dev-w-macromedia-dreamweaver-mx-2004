...
DatabaseType='<%# System.Configuration.ConfigurationSettings.AppSettings("MM_CONNECTION_DATABASETYPE_ConStr") %>' manualmode="true" oninserted="Insert1_Inserted"
>
  <Parameters>
...
<table width="750"  border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="620" valign="top"><br>
      ...
      <tr>
        <td align="right">&nbsp;</td>
        <td><asp:Button ID="btnOk" Text="Place Booking" OnClick="btnOk_Click" runat="server" />
